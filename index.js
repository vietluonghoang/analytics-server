...
.set('views', path.join(__dirname, 'views'))
.set('view engine', 'ejs')
.get('/analytics/view/range/:range', db.viewAnalytics)

//view analytics app_open
app.use(express.static(path.join(__dirname, 'public')))
.set('views', path.join(__dirname, 'views'))
.set('view engine', 'ejs')
.get('/analytics/app_open', db.viewAnalyticsAppopen)
app.use(express.static(path.join(__dirname, 'public')))
.set('views', path.join(__dirname, 'views'))
.set('view engine', 'ejs')
.get('/analytics/app_open/:id', db.viewAnalyticsAppopen)

//view analytics view_phantich
app.use(express.static(path.join(__dirname, 'public')))
.set('views', path.join(__dirname, 'views'))
.set('view engine', 'ejs')
.get('/analytics/view_phantich', db.viewAnalyticsViewphantich)
app.use(express.static(path.join(__dirname, 'public')))
.set('views', path.join(__dirname, 'views'))
.set('view engine', 'ejs')
.get('/analytics/view_phantich/:id', db.viewAnalyticsViewphantich)
